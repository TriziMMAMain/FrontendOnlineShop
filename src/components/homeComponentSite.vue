      ...
      <div class="headerblockInfo">
        <div class="infoPhone">
          <p class="infoPhoneText">
            <i class="fa fa-phone"></i> +7 (949) 412 91 53
          </p>
        </div>
        <div class="infoCity">
          <p class="infoCityText">
            <i class="fa fa-map-marker"></i> Россия, ДНР, Донецк, Ленинский район, пр. Алымова дом 10
          </p>
        </div>
      </div>
    </div>
